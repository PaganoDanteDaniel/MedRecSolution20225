...
namespace MedRec.DataContext.MySql.Migrations
{
    ...
    [Migration("20260813151358_RecreateMedicalAppointmentsView")]
    partial class RecreateMedicalAppointmentsView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.Professional", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.MedicalAppointment", b =>
                {
                    ...
                    b.HasOne("MedRec.Entity.POCOEntities.Professional", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.RolePermission", b =>
                {
                    b.HasOne("MedRec.Entity.POCOEntities.Permission", null)
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MedRec.Entity.POCOEntities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MedRec.Entity.POCOEntities.UserRole", b =>
                {
                    ...
                    b.HasOne("MedRec.Entity.POCOEntities.User", null)
                        .WithMany()
