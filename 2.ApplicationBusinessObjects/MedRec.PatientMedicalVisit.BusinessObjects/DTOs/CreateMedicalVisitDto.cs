namespace MedRec.PatientMedicalVisit.BusinessObjects.DTOs;
public class CreateMedicalVisitDto()
{
    ...
    public static explicit operator Entity.POCOEntities.PatientMedicalVisit(CreateMedicalVisitDto dto) =>
        new()
        {
