...
internal class PatientForMedicalVisitInteractor(
    IPatientForMedicalVisitOutputPort outputPort,
    IPatientQueriesRepository patientQueries,
    IHealthInsuranceQueriesRepository healthInsuranceQueries) : IPatientForMedicalVisitInputPort
{
